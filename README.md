...
A Python equivalent of the R [`grossman`](https://github.com/a-torgovitsky/grossman) package for accessing econometrics teaching datasets.

Data is hosted at [grossman-data](https://github.com/a-torgovitsky/grossman-data) and downloaded on demand with local caching.

## Installation

```bash
pip install git+https://github.com/YOUR_USERNAME/grossman-py.git
```
